...
class IndexSetting extends Form
{
    ...
    public function __construct($data = [], $key = null)
    {
        ...
        $this->dataKeys = [
            ...
            Constants::Index_Tab_Mode,
            Constants::Index_Tab_Mode_Ajax,
    ...
    public function form()
    {
        ...
        $this->tab('首页配置', function (Form $form) {
            ...
            $form->radio(Constants::Index_Tab_Mode, '网址块分类模式')->options(Constants::Data_Switch)->default(0)->help('网址块分类模式')
                ->when(1, function (Form $form) {
                    $form->switch(Constants::Index_Tab_Mode_Ajax, 'tab模型ajax加载数据')->default(0);
                });
            #endregion
            $this->divider();
