...
<script type='text/javascript' src='{{asset('asset/js/lazyload.min.js')}}' id='lightbox-js-js'></script>
<script type='text/javascript' src='{{mix('asset/js/app.js')}}' id='appjs-js'></script>@if(admin_setting(Constants::Color_Full_Loading,0))
